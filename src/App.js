					...
					<div className="pl-md-3">
						<div className="pt-md-3  wow fadeInUp">
							<span className="font_general line-height-15">
								Coolbeez is a unique Ethereum based Community Utility NFT featuring 6000 NFTs generated from hand drawn characters and 165 traits and is the first in a series of community collections from the My Meta Foundation (Hyper link to www.mymetafoundation.org). 
